 ...
 */
export default function BoardGrid({ rows = 13, cols = 13, cellSize = 48, onCellClick, renderContent }) {
            ...
            >
                {cells.map((cell) => (
                    <button
                        ...
                        className="relative transition hover:brightness-105 focus:outline-none focus:ring-2 focus:ring-emerald-300"
                    >
                        {renderContent ? (
