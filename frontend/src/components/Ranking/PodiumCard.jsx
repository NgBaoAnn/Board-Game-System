...
export function PodiumCard({ player, position }) {
  const configs = {
    1: {
      ...
      bgGradientDark: 'dark:bg-gradient-to-br dark:from-yellow-900/20 dark:via-yellow-800/10 dark:to-amber-900/20',
      bgGradientLight: 'bg-gradient-to-br from-yellow-100/50 via-amber-50/30 to-yellow-100/50',
    ...
    2: {
      borderColor: 'border-gray-400 dark:border-gray-400',
      bgGradientDark: 'dark:bg-gradient-to-br dark:from-slate-700/20 dark:via-gray-600/10 dark:to-slate-800/20',
      bgGradientLight: 'bg-gradient-to-br from-gray-100/50 via-slate-50/30 to-gray-100/50',
    ...
    3: {
      ...
      bgGradientDark: 'dark:bg-gradient-to-br dark:from-orange-900/20 dark:via-amber-800/10 dark:to-orange-800/20',
      bgGradientLight: 'bg-gradient-to-br from-orange-100/50 via-amber-50/30 to-orange-100/50',
  ...
  return (
    ...
    >
      <div
        className={`bg-white/90 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl border-t-4 ${config.borderColor} ${config.glowClass} p-6 flex flex-col items-center relative h-full border border-gray-200 dark:border-transparent`}
      >
        {/* Background gradient */}
        <div className={`absolute inset-0 ${config.bgGradientLight} ${config.bgGradientDark} rounded-2xl opacity-50`} />
        ...
        <div className="relative z-10 flex flex-col items-center mt-4 flex-1">
          ...
          <div className="relative mb-4">
            ...
            {position !== 1 && (
              <motion.div
                ...
                className="absolute -bottom-1 -right-1 bg-white dark:bg-slate-700 rounded-full p-1.5 shadow-lg border border-gray-200 dark:border-slate-600"
              >
                <Award size={14} className={position === 2 ? 'text-gray-500 dark:text-gray-300' : 'text-orange-500 dark:text-orange-400'} />
              </motion.div>
            )}
          </div>
          ...
          {/* Stats */}
          <div
            className={`flex items-center ${position === 1 ? 'gap-6' : 'gap-4'} w-full justify-center bg-gray-100/80 dark:bg-slate-900/50 backdrop-blur-sm ${position === 1 ? 'p-4' : 'p-3'} rounded-xl border border-gray-200 dark:border-slate-700/50 mt-auto`}
          >
            ...
            <div
              className={`w-px ${position === 1 ? 'h-10' : 'h-8'} bg-gray-300 dark:bg-slate-600`}
            />
            <div className="text-center">
              <p
                className={`text-[10px] ${position === 1 ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-500 dark:text-slate-400'} uppercase tracking-wider font-semibold mb-1`}
              ...
              <motion.p
                ...
                className={`${position === 1 ? 'text-xl' : 'text-lg'} font-bold text-green-600 dark:text-green-400`}
              >
                {player.winRate}%
              </motion.p>
            </div>
